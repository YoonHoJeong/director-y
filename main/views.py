...
from accounts.models import Actor, Director
...
def directors(request):
    all_portfolio = Movie.objects.all()
    director_profile = Director.objects.last()

    return render(request, "directors.html", {"all_portfolio": all_portfolio, "director_profile": director_profile})
